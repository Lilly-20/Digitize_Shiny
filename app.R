  ...
  dashboardBody(
    tabItems(
      tabItem(tabName = "about",
              ...
              h3("Acknowledgements"),
              p("The study of SurvdigitizeR was financially supported by an unrestricted grant from the Canadian Agency for Drugs and Technologies in Health (CADTH).

The Shiny app was developed through a collaborative effort, and we wish to express our deepest appreciation for the contributions made by the authors of the algorithm: Jasper Zhongyuan Zhang, Juan David Rios, Tilemanchos Pechlivanoglou, Alan Yang, Qiyue Zhang, Dimitrios Deris, Ian Cromwell, and Petros Pechlivanoglou.

We are also delighted to mention that the poster for this project was awarded", tags$b("first prize"), "in the virtual poster presentation competition at the 2023 Statistical Society of Canada Annual Meeting in May 2023 during the student conference (CSSC 2023) in Ottawa. This recognition further reinforces the relevance and impact of our work.")
      ),
